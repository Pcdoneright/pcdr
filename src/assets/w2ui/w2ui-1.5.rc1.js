        ...
        mergeChanges: function () {
            ...
            for (var c = 0; c < changes.length; c++) {
                ...
                for (var s in changes[c]) {
                    ...
                    // if (typeof changes[c][s] === "object") changes[c][s] = changes[c][s].text; //PCDR null value brakes code
                    try {
                        if (s.indexOf('.') != -1) {
        ...
        editField: function (recid, column, value, event) {
            ...
            switch (edit.type) {
                ...
                default:                
                    ...
                    $(input).select(); // pcdr Select Input Text
                    // add blur listener
                    setTimeout(function () {
                        var tmp = input;
                        if (edit.type == 'list') {
        ...
        editChange: function (el, index, column, event) {
            ...
            while (true) {
                ...
                if ((typeof new_val != 'object' && String(old_val) != String(new_val)) ||
                    (old_val == null && new_val == null) || // pcdr added null compare to prevent error
